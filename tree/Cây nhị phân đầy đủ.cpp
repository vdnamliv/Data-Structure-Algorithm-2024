// Cây nhị phân đầy đủ là cây mà mỗi đỉnh có 0 hoặc 2 đỉnh con. Viết chương trình nhập vào một cây có N
//  đỉnh và kiểm tra xem có phải là cây nhị phân đầy đủ hay không (các đỉnh của cây được đánh số từ 0
//  đến N−1
